...
```bash
# Show help
java -jar photostat-java-1.9.7-executable.jar --help

# Show CLI analysis help
java -jar photostat-java-1.9.7-executable.jar --analyze --help
...
java -jar photostat-java-1.9.7-executable.jar --analyze --provider moondream

# Analyze a specific directory
java -jar photostat-java-1.9.7-executable.jar --analyze --dir /path/to/photos

# Re-analyze everything (ignore cache)
java -jar photostat-java-1.9.7-executable.jar --analyze --force

# Quiet mode for scripts
java -jar photostat-java-1.9.7-executable.jar --analyze --quiet
...
```powershell
Start-Process -NoNewWindow -FilePath java -ArgumentList "-jar", "photostat-java-1.9.7-executable.jar", "--analyze"
```

**Linux/macOS:**

```bash
nohup java -jar photostat-java-1.9.7-executable.jar --analyze > analysis.log 2>&1 &
```

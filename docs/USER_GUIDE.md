...
# Minimal output
java -jar photostat-java-2.1.0-executable.jar --find-duplicates --quiet
```
...
java -jar photostat-java-2.1.0-executable.jar --detect-faces --dry-run

# Rescan all images (ignore previous results)
java -jar photostat-java-2.1.0-executable.jar --detect-faces --force

# Detection only (skip clustering)
java -jar photostat-java-2.1.0-executable.jar --detect-faces --detect-only

# Clustering only (on existing face data)
java -jar photostat-java-2.1.0-executable.jar --detect-faces --cluster-only
```
...
```bash
java -jar photostat-java-2.1.0-executable.jar --cache-thumbnails
```
...
java -jar photostat-java-2.1.0-executable.jar --cache-thumbnails --parallel 8

# Use 2 threads with minimal output
java -jar photostat-java-2.1.0-executable.jar --cache-thumbnails -p 2 --quiet
```
...
java -jar photostat-java-2.1.0-executable.jar --rclone-upload --dir /path/to/photos

# Minimal output
java -jar photostat-java-2.1.0-executable.jar --rclone-upload --quiet
```
...
java -jar photostat-java-2.1.0-executable.jar --cache-thumbnails --dry-run
```
...
```bash
nohup java -jar photostat-java-2.1.0-executable.jar --analyze --parallel 4 > analysis.log 2>&1 &
```

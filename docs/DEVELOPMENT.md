...
|---------------|------------|-----------|
| `mvn package` | `target/photostat-java-1.9.7-executable.jar` | Windows, Linux, macOS Apple Silicon |
| `mvn package -Pmac-intel` | `target/photostat-java-1.9.7-executable-mac-intel.jar` | Windows, Linux, macOS Intel |

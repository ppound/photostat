...
|---------------|------------|-----------|
| `mvn package` | `target/photostat-java-2.1.0-executable.jar` | Windows, Linux, macOS Apple Silicon |
| `mvn package -Pmac-intel` | `target/photostat-java-2.1.0-executable-mac-intel.jar` | Windows, Linux, macOS Intel |

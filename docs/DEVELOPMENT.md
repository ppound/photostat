...
|---------------|------------|-----------|
| `mvn package` | `target/photostat-java-2.6.3-executable.jar` | Windows, Linux, macOS Apple Silicon |
| `mvn package -Pmac-intel` | `target/photostat-java-2.6.3-executable-mac-intel.jar` | Windows, Linux, macOS Intel |

...
Download `PhotoStat-1.7.0.msi`, double-click to install, and launch from the Start Menu. No Java installation required.

#### Option B: macOS Installer (.dmg)

Download `PhotoStat-1.7.0.dmg`, open it, and drag PhotoStat to your Applications folder. No Java installation required.
...
Download `photostat-java-1.7.0-executable.jar`. Requires Java 21+.
...
java -jar photostat-java-1.7.0-executable.jar --find-duplicates

# Find visually similar images
java -jar photostat-java-1.7.0-executable.jar --find-duplicates --mode visual
```
